...
public class Deck 
{
    ...
    //A constructor which intializes the deck to a blank slate. The for loop just creates a slot in the map for each energy cost.
    public Deck() 
    {
    ...
    // Method to add valid cards to the deck
